<section class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<?php if(isset($articles)) : ?>
		<?php foreach ($articles as $article) : ?>
			<section id="article-container">
				<div class="row"><a href="/blog/read/<?php print $article->id_article; ?>"><?php print $article->title_article; ?></a></div>
				<div class="clearfix"></div>
				<div class="row"><?php print $article->description_article; ?></div>
				<div class="clearfix" role="separator"></div>
				<div class="row"><?php print $article->text_article; ?></div>
				<div class="clearfix" role="separator"></div>
				<div class="row">
	...
	<?php if(isset($article)): ?>
		...
		<div class="article-infos-container">
			<div class="row">
				<div class="col-xs-7 col-sm-3 col-md-3 col-lg-3 pull-right"> le <?php print $article->date;?></div>
